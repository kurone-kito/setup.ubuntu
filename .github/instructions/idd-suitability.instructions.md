...
The numeric `<!-- setup-ubuntu-autopilot-suitability: N -->`
...
`<!-- setup-ubuntu-autopilot-suitability: N -->` authoring
convention:

```markdown
<!-- setup-ubuntu-triage-verdict: <outcome> -->
```
...
`setup-ubuntu-triage-verdict` marker. Apply the same
