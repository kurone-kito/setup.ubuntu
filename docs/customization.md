...
| ------------------------------------------------------------------- | -------------------------------- |
| `idd-skill` in repo-name contexts                                   | `setup.ubuntu`                  |
| `idd-skill` in marker-prefix contexts (e.g. `idd-skill-roadmap-id`) | `setup-ubuntu`      |
| **fix-validate** command string                                     | `npx -y markdownlint-cli2 --fix "**/*.md" && npx -y markdownlint-cli2 "**/*.md"`      |
| **pre-push-validate** command string                                | `npx -y markdownlint-cli2 "**/*.md" && npx -y cspell lint "**" --no-progress` |
| **post-fix-validate** command string                                | `npx -y markdownlint-cli2 --fix "**/*.md" && npx -y markdownlint-cli2 "**/*.md" && npx -y cspell lint "**" --no-progress` |
...
- `audit-docs.mjs` enforces synchronization rules defined in
  `sync-manifest.json`
- Template copies use placeholders like `setup.ubuntu` to support
